...
function handleSuccessResponse(data, inputUrl) {
    ...
    if (data.data) {
        ...
        document.title = videoData.title ? `Download ${videoData.title.replace(/\+/g, ' ')} VKrDownloader` : "Download RgDownloader";
        ...
        alert("Issue: Unable to get download link. Please check the URL or try after some times");
        document.getElementById("loading").style.display = "none";
    }
}
